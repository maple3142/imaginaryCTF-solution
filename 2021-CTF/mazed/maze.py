...
if __name__ == "__main__":
    try:
        ...
        print()
        print(
            "The above is a 50x50x50 maze. That is to say, it's a hypercube with side length 50."
        )
        print(
            "You have 10 seconds (minus any time you spend reading!) to find the flag. You are denoted as the '@', and the flag is 'F'."
        )
        print()
        print(
            "The maze is represented internally as a 5 dimensional list. The 5 dimensions are labelled A, B, C, D, and E, respectively. You will input a string denoting a series of moves. A capital 'A' denotes moving 1 unit in the positive A direction, while a lowercase 'c' denotes moving 1 step in the negative C direction."
        )
        print()
        print("Good luck!")
        print()
